...
const [modal, setModal] = useState(true)
  ...
  return (
    <dialog id='mdl' className='max-w-380 cursor-pointer bg-white rounded-lg max-w-115 w-120 absolute top-9 translate-3 sm:translate-10 md:translate-x-55' open={modal}>
